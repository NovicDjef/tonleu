...
async function resolveConfig(appConfig, {
  ...
  var _appConfig$future, _appConfig$future2, _appConfig$future3;
  ...
  let future = {
    ...
    v3_throwAbortReason: ((_appConfig$future3 = appConfig.future) === null || _appConfig$future3 === void 0 ? void 0 : _appConfig$future3.v3_throwAbortReason) === true
  };
  if (appConfig.future) {
