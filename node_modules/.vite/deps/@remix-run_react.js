...
function getRouteComponents(route, routeModule, isSpaMode) {
  ...
  if (route.id === "root" && routeModule.Layout) {
    return {
      ...Component3 ? {
        element: React6.createElement(routeModule.Layout, null, React6.createElement(Component3))
      } : {
        Component: Component3
      },
      ...ErrorBoundary ? {
        errorElement: React6.createElement(routeModule.Layout, null, React6.createElement(ErrorBoundary))
      } : {
        ErrorBoundary
      },
      ...HydrateFallback ? {
        hydrateFallbackElement: React6.createElement(routeModule.Layout, null, React6.createElement(HydrateFallback))
      } : {
        HydrateFallback
      }
    };
